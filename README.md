...
|---|---:|---|
| Código do jogo | 35.636 linhas em 51 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Clipes de animação versionados | 575 | `git ls-files public/models/anims \| wc -l` |
