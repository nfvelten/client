...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.078 |
| `public/js/main.js` | 2.703 |
...
Total de `public/js/`: **35.187 linhas em 51 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
