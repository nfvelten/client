...
|---|---:|---|
| Game code | 35,939 lines in 52 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,078** lines | `wc -l public/js/game.js` |
| `main.js` | 2,704 lines | `wc -l public/js/main.js` |
...
| Pipeline scripts | 60 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.205` | `public/js/version.js` and `package.json` (match) |
