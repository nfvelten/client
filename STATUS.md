...
- **Versão:** `2.0.0-alpha.184`
- **Conteúdo jogável:** 10 facções, 62 personagens, 17 mapas e 27 armas com GLB
- **Código do jogo:** 41.619 linhas em 59 módulos JavaScript
- **Automação:** 188 comandos npm, 304 scripts de avaliação e 77 scripts de pipeline
